...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='AuditApprovisionnement',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('action', models.CharField(choices=[('INSERT', 'Ajout'), ('UPDATE', 'Modification'), ('DELETE', 'Suppression')], max_length=10)),
                ('date', models.DateTimeField(auto_now_add=True)),
                ('fournisseur_nom', models.CharField(max_length=100)),
                ('produit_design', models.CharField(max_length=100)),
                ('qteentree_ancien', models.IntegerField(blank=True, null=True)),
                ('qteentree_nouv', models.IntegerField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('USER', 'Utilisateur'), ('ADMIN', 'AdminAudit')], default='USER', max_length=10)),
